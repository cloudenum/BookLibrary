...
class MenusTableSeeder extends Seeder
{
    ...
    */
    ...
    public function run()
    {
        ...
        $this->insertLink('user,admin', 'Books', '/book', 'cil-book');
        $this->insertLink('user,admin', 'Writers', '/writer', 'cil-pen-alt');
        $this->beginDropdown('admin', 'Settings', 'cil-cog');
        ...
        $this->insertLink('user,admin', 'Books',              '/book');
        $this->insertLink('user,admin', 'Writers',             '/writer');
        $this->insertLink('admin', 'Users',                   '/users');
        $this->endDropdown();
